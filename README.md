...
hackMyREADME is a simple CLI README.md generator application.
    ...
    I learned so much developing this application. Everything from exporting js functions to be imported and invoked in other files, to using imports rather than require(), all the way to effectively utilizing node inquirer. I specifically enjoyed using inquirer's when value to only ask a question dependent on the developers response to a previous question.
